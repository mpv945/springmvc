 ...
 * 
 */
package org.haijun.study.hibernate;
...
/**
 * 注解说明参考https://www.cnblogs.com/liangxinxinbo/p/6092664.html
 * 最新版的Hibernate 5使用https://www.cnblogs.com/lakeslove/p/5990402.html
 * 信用卡对账单模型.<br>
...
@Entity
@Table(name="t_credit")
public class HibernateCreditBill {
	@Id
	@Column(name="ID")
	private String id;
